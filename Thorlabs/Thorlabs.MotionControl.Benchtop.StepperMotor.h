...
extern "C"
{
	...
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="SBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_GetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softwareModes);
	...
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="SBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes)" />
	BENCHTOPSTEPPERMOTOR_API short __cdecl SBC_SetLimitSwitchParams(char const * serialNo, short channel, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes);
	...
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="SBC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes)" />
	/// <seealso cref="SBC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softwareModes)" />
	...
	/// <param name="pitch">	    The pitch. </param>
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="SBC_SetMotorParams(char const * serialNo, short channel, long stepsPerRev, long gearBoxRatio, float pitch)" />
