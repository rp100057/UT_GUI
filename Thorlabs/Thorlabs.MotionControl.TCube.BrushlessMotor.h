...
extern "C"
{
	...
	{
		/// <summary> The device Type ID. </summary>
		DWORD typeID;
	...
	struct TLI_HardwareInformation
	{
		...
		/// 		   <list type=table>
		///				<item><term>Benchtop Brushless Motor</term><term>73</term></item>
		///				<item><term>Benchtop NanoTrak</term><term>22</term></item>
		///				<item><term>Benchtop Piezo (1 channel)</term><term>41</term></item>
		///				<item><term>Benchtop Piezo (3 channel)</term><term>71</term></item>
		///				<item><term>Benchtop Stepper Motor (1 channel)</term><term> 40</term></item>
		///				<item><term>Benchtop Stepper Motor (3 channel)</term><term>70</term></item>
		///				<item><term>Filter Flipper</term><term>37</term></item>
		///				<item><term>Filter Wheel</term><term>47</term></item>
		///				<item><term>Long Travel Stage</term><term>45</term></item>
		///				<item><term>Cage Rotator</term><term>55</term></item>
		///				<item><term>LabJack 490</term><term>46</term></item>
		///				<item><term>LabJack 050</term><term>49</term></item>
		///				<item><term>Modular NanoTrak</term><term>52</term></item>
		///				<item><term>Modular Piezo</term><term>51</term></item>
		///				<item><term>Modular Stepper Motor</term><term>50</term></item>
		///				<item><term>TCube Brushless Motor</term><term>67</term></item>
		///				<item><term>TCube DC Servo</term><term>83</term></item>
		///				<item><term>TCube Inertial Motor</term><term>65</term></item>
		///				<item><term>TCube LaserSource</term><term>86</term></item>
		///				<item><term>TCube LaserDiode</term><term>64</term></item>
		///				<item><term>TCube NanoTrak</term><term>82</term></item>
		///				<item><term>TCube Quad</term><term>89</term></item>
		///				<item><term>TCube Solenoid</term><term>85</term></item>
		///				<item><term>TCube Stepper Motor</term><term>80</term></item>
		///				<item><term>TCube Strain Gauge</term><term>84</term></item>
		///				<item><term>TCube TEC</term><term>87</term></item>
		/// 		  </list></remarks>
		WORD type;
	...
	struct MOT_LimitSwitchParameters
	{
		...
		/// 		  </list> </remarks>
		MOT_LimitSwitchSWModes softwareModes;
	};
	...
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	...
	/// <param name="stringsReceiver"> Outputs a SAFEARRAY of strings holding device serial numbers. </param>
	/// <param name="typeIDs"> list of typeIDs of devices to be matched</param>
	...
	/// <returns>	The error code or zero if successful. </returns>
	...
	/// <returns>	The error code or zero if move successfully started. </returns>
	...
	/// <param name="softwareModes"> The software limit mode
	/// 					 <list type=table>
	...
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="BMC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes)" />
	/// <seealso cref="BMC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	/// <seealso cref="BMC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BRUSHLESSMOTOR_API short __cdecl BMC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softwareModes);
	...
	/// 					 </list> <remarks> If these are bitwise-ORed with 0x0080 then the limits are swapped. </remarks> </param>
	/// <returns> The error code or zero if successful, see \ref C_DLL_ERRORCODES_page "Error Codes". </returns>
	/// <seealso cref="BMC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softwareModes)" />
	/// <seealso cref="BMC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	/// <seealso cref="BMC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BRUSHLESSMOTOR_API short __cdecl BMC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes);
	...
	/// <seealso cref="BMC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softwareModes)" />
	/// <seealso cref="BMC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BRUSHLESSMOTOR_API short __cdecl BMC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	/// <seealso cref="BMC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softwareModes)" />
	/// <seealso cref="BMC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
	BRUSHLESSMOTOR_API short __cdecl BMC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
	...
	/// <param name="serialNo"> The device serial no. </param>
	/// <returns> The error code or zero if successfully requested. </returns>
    /// 		  \include CodeSnippet_move.cpp
	/// <seealso cref="BMC_GetPosition(char const * serialNo)" />
